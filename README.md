...
<head>
  ...
  <title>APRENDE A PROGRAMAR AHORA</title>
  ...
  <style>
    ...
    body {
      ...
      margin: 0;
      padding: 0;
      background: linear-gradient(135deg, #80b0ff, #ffffff);
    ...
    .container {
      ...
      max-width: 800px; /* Más ancho para mayor espacio horizontal */
      padding: 20px;
      border-radius: 10px;
      text-align: center;
